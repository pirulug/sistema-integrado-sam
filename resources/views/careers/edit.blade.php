        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <span class="h5 mb-0">{{ __("Editar Programa de Estudio") }}</span>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error("name") is-invalid @enderror" 
                                       name="name" value="{{ old("name", $career->name) }}" required autofocus>
                                @error("name")
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="code" type="text" class="form-control @error("code") is-invalid @enderror" 
                                       name="code" value="{{ old("code", $career->code) }}">
                                @error("code")
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea id="description" class="form-control @error("description") is-invalid @enderror" 
                                          name="description" rows="4">{{ old("description", $career->description) }}</textarea>
                                @error("description")
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select id="status" class="form-select @error("status") is-invalid @enderror" name="status" required>
                                    <option value="activo" {{ old("status", $career->status) === "activo" ? "selected" : "" }}>{{ __("Activo") }}</option>
                                    <option value="inactivo" {{ old("status", $career->status) === "inactivo" ? "selected" : "" }}>{{ __("Inactivo") }}</option>
                                </select>
                                @error("status")
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                            ...
                            <div class="col-md-6 pt-2">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" name="shifts[]" value="Mañana" id="shift_morning"
                                        {{ in_array("Mañana", old("shifts", $career->shifts ?? [])) ? "checked" : "" }}>
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" name="shifts[]" value="Tarde" id="shift_afternoon"
                                        {{ in_array("Tarde", old("shifts", $career->shifts ?? [])) ? "checked" : "" }}>
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" name="shifts[]" value="Noche" id="shift_evening"
                                        {{ in_array("Noche", old("shifts", $career->shifts ?? [])) ? "checked" : "" }}>
