        ...
        <div class="col-md-10">
            ...
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a href="{{ route("careers.edit", $career->id) }}" class="btn btn-warning btn-sm text-white me-1">
                            {{ __("Editar") }}
                        </a>
                ...
                <div class="card-body">
                    <table class="table table-bordered">
                        <tbody>
                            <tr>
                                <th class="w-25 bg-light">{{ __("Nombre") }}</th>
                                <td><strong>{{ $career->name }}</strong></td>
                            </tr>
                            <tr>
                                <th class="w-25 bg-light">{{ __("Código / Sigla") }}</th>
                                <td>{{ $career->code ?? __("N/A") }}</td>
                            </tr>
                            <tr>
                                <th class="w-25 bg-light">{{ __("Descripción") }}</th>
                                <td>{{ $career->description ?? __("Sin descripción") }}</td>
                            </tr>
                            <tr>
                                <th class="w-25 bg-light">{{ __("Estado") }}</th>
                                <td>
                                ...
                                @forelse ($teachers as $teacher)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route("teachers.show", $teacher->id) }}" class="btn btn-info btn-sm text-white">
                                                {{ __("Ver Profesor") }}
                                            </a>
                                        </td>
                                    </tr>
