                    ...
                    <form method="POST" action="{{ route('efsrts.store') }}" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="module" name="module" type="text" class="mt-1 block w-full" :value="old('module')" required autofocus placeholder="ej. Modulo I" />
                            ...
                            <div>
                                ...
                                <x-text-input id="module_name" name="module_name" type="text" class="mt-1 block w-full" :value="old('module_name')" placeholder="ej. Soporte Técnico y Redes" />
