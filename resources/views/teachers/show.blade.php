                        ...
                        <div class="bg-gray-50 dark:bg-gray-900/50 p-4 rounded-lg border border-gray-100 dark:border-gray-800">
                            ...
                            <div class="space-y-3">
                                <div>
                                    ...
                                    <span class="text-sm font-semibold">{{ $teacher->dni }}</span>
                                </div>
                                <div>
                                    <span class="text-xs text-gray-500 dark:text-gray-400 block">Código de Profesor</span>
                                    <span class="text-sm font-semibold">{{ $teacher->teacher_code }}</span>
                                </div>
                                <div>
                        ...
                        <div class="bg-gray-50 dark:bg-gray-900/50 p-4 rounded-lg border border-gray-100 dark:border-gray-800">
                            ...
                            <div class="space-y-3">
                                <div>
                                    ...
                                    <span class="text-sm font-semibold break-all">{{ $teacher->institutional_email }}</span>
                                </div>
                                <div>
